...
class SCD4X:
    ...
    **Quickstart: Importing and using the SCD4X**
    ...
    def __init__(self, i2c_bus: I2C, address: int = SCD4X_DEFAULT_ADDR) -> None:
        ...
        # cached readings
        self._temperature: Union[float, None] = None
        self._relative_humidity: Union[float, None] = None
        self._co2: Union[int, None] = None

        self.stop_periodic_measurement()

    @property
    def CO2(self) -> Union[int, None]:  # pylint:disable=invalid-name
    ...
    @property
    def relative_humidity(self) -> Union[float, None]:
